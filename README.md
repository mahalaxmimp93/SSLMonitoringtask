...
The main goal is to: Checks SSL certificate expiry of websites, Calculates remaining days, Shows warning if expiry is near,Runs automatically every day and Sends alert if certificate is expiring

2. Real-Time Industry Problem

Many outages happen because:SSL certificates expire unexpectedly, Incorrect intermediate certificates are configured and Teams forget manual renewal dates. 
Example:
