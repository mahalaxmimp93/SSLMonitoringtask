...
This project automatically monitors SSL/TLS certificates of websites, validates expiry dates, checks renewal status and sends alerts before expiration
...
cd ssl-monitor-project________________________________________
